...
ysc(r(-0.4 0.4)) 
graph export "$doc\figEng_noMex.png", replace
...
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
ysc(r(-2 2)) 
graph export "$doc\figEdu_noMex.png", replace
*========================================================================*
...
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
ysc(r(-0.2 0.2)) 
graph export "$doc\figWork_noMex.png", replace
...
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
ysc(r(-1 1)) 
graph export "$doc\figWages_noMex.png", replace