...
*========================================================================*
reghdfe school treat_* yrsusa1 [aw=perwt], absorb(bpld cohort year yrimmig) vce(cluster cluster)
...
*========================================================================*
reghdfe married treat_* educ sex yrsusa1 [aw=perwt] if cohort<2007, absorb(bpld cohort year yrimmig) vce(cluster cluster)
...
*========================================================================*
reghdfe olang treat_* educ sex yrsusa1 [aw=perwt] if cohort<2007, absorb(bpld cohort year yrimmig) vce(cluster cluster)
