...
eststo: xtreg dln_sb_transfer_cur dltaIV if year<=2007, fe vce(robust)
eststo: xtreg dln_lpc_transfer_cur dltaIV if year<=2007, fe vce(robust)
...
eststo: xtreg dln_sb_other_cur dloeIV if year<=2007, fe vce(robust)
