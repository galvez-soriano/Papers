...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_totalutilcuroper dln_sb_totalutilcuroper if B_iv_nmc1!=., fe vce(robust)
eststo: xtreg dln_sb_totalutilcuroper B_iv_nmc* if dln_lpc_totalutilcuroper!=., fe vce(robust)
eststo: xtreg dln_lpc_totalutilcuroper B_iv_nmc*, fe vce(robust)
eststo: xtivreg2 dln_lpc_totalutilcuroper (dln_sb_totalutilcuroper = B_iv_nmc*), fe robust
esttab using "$doc\tab_BartikUO.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totalutilcuroper B_iv_nmc*) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
eststo: xtreg dln_sb_totalutilcuroper dluoIV if B_iv_nmc1!=. & year>=1990 & dln_lpc_totalutilcuroper!=., fe vce(robust)
...
eststo: xtreg dln_sb_totalutilcuroper dluoIV if B_iv_nmc1!=. & year>=1990 & one_city==0 & dln_lpc_totalutilcuroper!=., fe vce(robust)
...
eststo: xtreg dln_sb_totalutilcuroper dluoIV if B_iv_nmc1!=. & year>=1990 & one_city==1 & dln_lpc_totalutilcuroper!=., fe vce(robust)
...
eststo: xtreg dln_sb_totalutilcuroper dluoIV if dln_lpc_totalutilcuroper!=., fe vce(robust)
eststo: xtreg dln_lpc_totalutilcuroper dluoIV if dln_sb_totalutilcuroper!=., fe vce(robust)
