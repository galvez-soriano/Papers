...
label var dln_sb_transfer_cur "Suburb TranE"
label var dln_sb_other_cur "Suburb OE"
label var ltrIV "IV other suburbs TR"
label var lttIV "IV other suburbs TT"
label var ltoIV "IV other suburbs CO"
label var lbeIV "IV other suburbs BE"
label var ltaIV "IV other suburbs TranE"
label var loeIV "IV other suburbs OE"
keep id_govs year msa_sc ltrIV lttIV ltoIV lbeIV ltaIV loeIV one_city B_iv_nmc1 ///
...
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totalrevenue ltrIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
*========================================================================*
/* Total Taxes */ 
*========================================================================*
...
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totaltaxes lttIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
*========================================================================*
/* Current Operations */
*========================================================================*
...
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totalcurrentoper ltoIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
*========================================================================*
/* Basic Expenditure */ 
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_basic_cur dln_sb_basic_cur if lbeIV!=., fe vce(robust)
eststo: xtreg dln_sb_basic_cur lbeIV, fe vce(robust)
eststo: xtreg dln_lpc_basic_cur lbeIV, fe vce(robust)
eststo: xtivreg2 dln_lpc_basic_cur (dln_sb_basic_cur = lbeIV), fe robust
esttab using "$doc\tab_IV_BE.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_basic_cur lbeIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
*========================================================================*
/* Transfer Expenditure */
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_transfer_cur dln_sb_transfer_cur if ltaIV!=., fe vce(robust)
eststo: xtreg dln_sb_transfer_cur ltaIV, fe vce(robust)
eststo: xtreg dln_lpc_transfer_cur ltaIV, fe vce(robust)
eststo: xtivreg2 dln_lpc_transfer_cur (dln_sb_transfer_cur = ltaIV), fe robust
esttab using "$doc\tab_IV_TranE.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_transfer_cur ltaIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
*========================================================================*
/* Other Expenditure */
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_other_cur dln_sb_other_cur if loeIV!=., fe vce(robust)
eststo: xtreg dln_sb_other_cur loeIV, fe vce(robust)
eststo: xtreg dln_lpc_other_cur loeIV, fe vce(robust)
eststo: xtivreg2 dln_lpc_other_cur (dln_sb_other_cur = loeIV), fe robust
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_totalrevenue dln_sb_totalrevenue if ltrIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_totalrevenue ltrIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_totalrevenue ltrIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_totalrevenue (dln_sb_totalrevenue = ltrIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_TR.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totalrevenue ltrIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_totaltaxes dln_sb_totaltaxes if lttIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_sb_totaltaxes lttIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_totaltaxes lttIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_totaltaxes (dln_sb_totaltaxes = lttIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_TT.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totaltaxes lttIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_totalcurrentoper dln_sb_totalcurrentoper if ltoIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_sb_totalcurrentoper ltoIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_totalcurrentoper ltoIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_totalcurrentoper (dln_sb_totalcurrentoper = ltoIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_TO.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_totalcurrentoper ltoIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_basic_cur dln_sb_basic_cur if lbeIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_sb_basic_cur lbeIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_basic_cur lbeIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_basic_cur (dln_sb_basic_cur = lbeIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_BE.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_basic_cur lbeIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_transfer_cur dln_sb_transfer_cur if ltaIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_sb_transfer_cur ltaIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_transfer_cur ltaIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_transfer_cur (dln_sb_transfer_cur = ltaIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_TranE.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_transfer_cur ltaIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace
...
*========================================================================*
eststo clear
eststo: xtreg dln_lpc_other_cur dln_sb_other_cur if loeIV!=. & B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_sb_other_cur loeIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtreg dln_lpc_other_cur loeIV if B_iv_nmc1!=. & year>=1990, fe vce(robust)
eststo: xtivreg2 dln_lpc_other_cur (dln_sb_other_cur = loeIV) if B_iv_nmc1!=. & year>=1990, fe robust
esttab using "$doc\tab_IV_OE.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Effect of suburbs on central cities ///
(Suburbs IV)) keep(dln_sb_other_cur loeIV) label ///
stats(N r2 F, fmt(%9.0fc %9.3f)) replace