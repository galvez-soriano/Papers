...
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age indigen i.loc_size if age>=6 & age<=24 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
...
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age indigen i.loc_size if age>=6 & age<=24 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ indigen i.loc_size if age>=6 & age<=24 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ indigen i.loc_size if age>=25 & age<=54 & female==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
...
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age female i.loc_size if age>=6 & age<=24 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
...
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age female i.loc_size if age>=6 & age<=24 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female i.loc_size if age>=6 & age<=24 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female i.loc_size if age>=25 & age<=54 & indigen==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
esttab using "$doc\tab1D.tex", r2 cells(b(star fmt(%9.3f)) se(par)) title(DiD estimations) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N r2, fmt(%9.0fc %9.3f)) label replace keep(treat_after)
*=====================================================================*
/* Panel E */
*=====================================================================*
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age female indigen i.loc_size if age>=6 & age<=24 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==1 [aw=weight], absorb(geo year state#year) vce(cluster geo)
esttab using "$doc\tab1E.tex", r2 cells(b(star fmt(%9.3f)) se(par)) title(DiD estimations) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N r2, fmt(%9.0fc %9.3f)) label replace keep(treat_after)
*=====================================================================*
/* Panel F */
*=====================================================================*
eststo clear
*Time use Young
eststo: reghdfe time_study treat_after hhsize age female indigen i.loc_size if age>=6 & age<=24 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female indigen i.loc_size if age>=6 & age<=24 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
*Time use Adult
eststo: reghdfe time_study treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe t_work treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_leisure treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
eststo: reghdfe time_other treat_after hhsize age educ female indigen i.loc_size if age>=25 & age<=54 & rururb==0 [aw=weight], absorb(geo year state#year) vce(cluster geo)
esttab using "$doc\tab1F.tex", r2 cells(b(star fmt(%9.3f)) se(par)) title(DiD estimations) ///
star(* 0.10 ** 0.05 *** 0.01) stats(N r2, fmt(%9.0fc %9.3f)) label replace keep(treat_after)
*=====================================================================*
/* Figure 1 */
*=====================================================================*
