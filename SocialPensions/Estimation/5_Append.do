...
label var hwork "Labor Supply (hours)"
rename rururb rural
label var rural "$s_{l} < 2,500$"
gen suburb=tam_loc==3
label var suburb "$2,500 \leq s_{l} < 15,000$"
gen urban=tam_loc==2
label var urban "$15,000 \leq s_{l} < 100,000$"
gen city=tam_loc==1
label var city "$s_{l} \geq 100,000$"
rename sexo gender
rename edad age
rename ent state
