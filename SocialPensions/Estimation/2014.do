...
Todas las bases de  datos del MCS 2014 deben estar en formato *.dta

En este programa se utilizan las siguientes bases, 
renombrándolas de la siguiente forma:

Base de población: Pobla14.dta
...
1) Bases originales: "C:\Pobreza 2014\MCS"
2) Bases generadas: "C:\Pobreza 2014\Bases"
3) Bitácoras: "C:\Pobreza 2014\log"
...
gl bases="C:\Users\galve\Documents\Papers\Current\Social pension program\Data\2014\Bases";
...
save "$bases\65 y mas_2014.dta", replace;

use "$data\Vivienda.dta", clear;
keep proyecto folioviv tenencia;
destring tenencia, replace;
sort proyecto folioviv ;
merge m:m proyecto folioviv using "$bases\65 y mas_2014.dta";
drop _merge;
save "$bases\65 y mas_2014.dta", replace;
...
sort proyecto folioviv foliohog numren;
merge m:m proyecto folioviv foliohog numren using "$bases\65 y mas_2014.dta";
drop _merge;
save "$bases\65 y mas_2014.dta", replace;
