...
/* Primaria General */
use "$data\2010\PRIMGI10.dta", clear
...
save "$base\stat911_10.dta", replace

/* Primaria Indígena */
use "$data\2010\PRIMII10.dta", clear
...
append using "$base\stat911_10.dta"
sort cct
save "$base\stat911_10.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2010\PRIMCI10.dta", clear
