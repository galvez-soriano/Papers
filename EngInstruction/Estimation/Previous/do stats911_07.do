...
/* Primaria General */
use "$data\2007\PRIMGI07.dta", clear
...
save "$base\stat911_07.dta", replace

/* Primaria Indígena */
use "$data\2007\PRIMII07.dta", clear
...
append using "$base\stat911_07.dta"
sort cct
save "$base\stat911_07.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2007\PRIMCI07.dta", clear
