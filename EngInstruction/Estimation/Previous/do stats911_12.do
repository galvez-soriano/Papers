...
/* Primaria General */
use "$data\2012\PRIMGI12.dta", clear
...
save "$base\stat911_12.dta", replace

/* Primaria Indígena */
use "$data\2012\PRIMII12.dta", clear
...
append using "$base\stat911_12.dta"
sort cct
save "$base\stat911_12.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2012\PRIMCI12.dta", clear
