...
/* Primaria General */
use "$data\2008\PRIMGI08.dta", clear
...
save "$base\stat911_08.dta", replace

/* Primaria Indígena */
use "$data\2008\PRIMII08.dta", clear
...
append using "$base\stat911_08.dta"
sort cct
save "$base\stat911_08.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2008\PRIMCI08.dta", clear
