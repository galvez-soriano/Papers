...
/* Primaria General */
use "$data\2009\PRIMGI09.dta", clear
...
save "$base\stat911_09.dta", replace

/* Primaria Indígena */
use "$data\2009\PRIMII09.dta", clear
...
append using "$base\stat911_09.dta"
sort cct
save "$base\stat911_09.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2009\PRIMCI09.dta", clear
