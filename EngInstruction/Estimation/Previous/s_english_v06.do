...
*========================================================================*
foreach x in 03 04 05 06 07 08 09 10 11 12 13{
/* Primaria General */
...
/* Potential hours of English instruction by the policy */
gen h_group_policy=hours_eng/total_groups if year<=2008
replace h_group_policy=hours_eng/total_groups if year>=2009 & had_e==1
replace h_group_policy=hours_eng/group_2009 if year==2009 & had_e==0
replace h_group_policy=hours_eng/group_2010 if year==2010 & had_e==0
replace h_group_policy=hours_eng/total_groups if year>=2011 & had_e==0
replace h_group_policy=0 if h_group_policy==.
label var h_group_policy "Hours of English instruction (per class)"
...
/* Potential number of English teachers by the policy */
gen teach_g_policy=teach_eng/total_groups if year<=2008
replace teach_g_policy=teach_eng/total_groups if year>=2009 & had_e==1
replace teach_g_policy=teach_eng/group_2009 if year==2009 & had_e==0
replace teach_g_policy=teach_eng/group_2010 if year==2010 & had_e==0
replace teach_g_policy=teach_eng/total_groups if year>=2011 & had_e==0
replace teach_g_policy=0 if teach_g_policy==.
label var teach_g_policy "English teachers (per class)"
...
keep if same_school>=7 & same_school<=11
drop same_school
