...
*========================================================================*
use "$base\dbase0613s.dta", clear
eststo clear
eststo: areg s_spa eng gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_math eng gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_spa eng gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
eststo: areg s_math eng gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
esttab using "$doc\tab1.tex", ar2 se b(a2) title(Structural equation \label{tab1}) label replace

eststo clear
eststo: areg s_spa h_group gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_math h_group gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_spa h_group gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
eststo: areg s_math h_group gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
esttab using "$doc\tab2.tex", ar2 se b(a2) title(Structural equation \label{tab2}) label replace

eststo clear
eststo: areg s_spa teach_g gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_math teach_g gender n_students grade total_stud i.year, absorb(id_geo) vce(cluster cct)
eststo: areg s_spa teach_g gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
eststo: areg s_math teach_g gender n_students grade total_stud i.year, absorb(cct) vce(cluster cct)
esttab using "$doc\tab3.tex", ar2 se b(a2) title(Structural equation \label{tab3}) label replace
*========================================================================*
...
eststo: areg h_group total_stud total_groups i.year, absorb(id_geo) vce(cluster id_geo)
eststo: areg teach_g total_stud total_groups i.year, absorb(id_geo) vce(cluster id_geo)
