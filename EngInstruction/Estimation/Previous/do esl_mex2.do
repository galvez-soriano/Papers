...
clear
set more off
gl data= "C:\Users\Oscar Galvez\Documents\Papers\Current\English on labor outcomes\Data\ENLACE"
gl base= "C:\Users\Oscar Galvez\Documents\Papers\Current\English on labor outcomes\Data"
gl doc= "C:\Users\Oscar Galvez\Documents\Papers\Current\English on labor outcomes\Doc"
*========================================================================*
/* ENLACE 2007 */
*========================================================================*
...
sum s_spa s_math gender n_students n_group
...
sum high_abil indig_stud anglo_stud latino_stud other_stud disabil ///
teach_eng hours_eng h_eng_pt teach_elem teach_midle teach_high ///
teach_colle teach_mast teach_phd school_supp_exp uniform_exp tuition
...
n_group, robust
eststo: quietly reg s_spa after_treat after treat gender n_students ///
n_group high_abil indig_stud anglo_stud latino_stud other_stud disabil ///
teach_eng hours_eng h_eng_pt teach_elem teach_midle teach_high ///
teach_colle teach_mast teach_phd school_supp_exp uniform_exp tuition, robust

eststo: quietly reg s_spa after_treat after treat if rururb==0, robust
eststo: quietly reg s_spa after_treat after treat gender n_students if ///
rururb==0, robust

esttab using "$doc\tab1.tex", ar2 se b(a2) title(Difference in ///
differences results (Spanish test scores) \label{tab1}) label replace

* Math test scores
eststo clear
eststo: quietly reg s_math after_treat after treat, robust
eststo: quietly reg s_math after_treat after treat gender n_students, robust

eststo: quietly reg s_math after_treat after treat if rururb==0, robust
eststo: quietly reg s_math after_treat after treat gender n_students if ///
rururb==0, robust

esttab using "$doc\tab2.tex", ar2 se b(a2) title(Difference in ///
differences results (Math test scores) \label{tab2}) label replace
...
eststo clear
eststo: quietly reg s_spa after_treat after treat
eststo: quietly reg s_spa after_treat after treat gender n_students

eststo: quietly reg s_spa after_treat after treat if rururb==0
eststo: quietly reg s_spa after_treat after treat gender n_students if rururb==0

esttab using "$doc\tab2.tex", ar2 se b(a2) title(Placebo test ///
\label{tab2}) label replace
