...
/* Primaria General */
use "$data\2011\PRIMGI11.dta", clear
...
save "$base\stat911_11.dta", replace

/* Primaria Indígena */
use "$data\2011\PRIMII11.dta", clear
...
append using "$base\stat911_11.dta"
sort cct
save "$base\stat911_11.dta", replace

/* Primaria Comunitaria Rural */
use "$data\2011\PRIMCI11.dta", clear
