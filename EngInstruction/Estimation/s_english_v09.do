...
gl doc= "C:\Users\iscot\OneDrive\Documents\Papers\EngInst\Doc"
*========================================================================*
clear
...
/* Zeros and non-zeros */
gen h_group2008=h_group>0 if year==2008
gen h_group2011=h_group>0 if year==2011
egen mean08=mean(h_group2008) if year==2008
gen h_group08=mean08 if year==2008 & h_group>0
replace h_group08=1-mean08 if year==2008 & h_group==0
egen mean11=mean(h_group2011) if year==2011
gen h_group11=mean11 if year==2011 & h_group>0
replace h_group11=1-mean11 if year==2011 & h_group==0

gen h_groupa=h_group>0 
gen geng=0 if h_group==0
replace geng=1 if h_group>0
label define geng 0 "No English" 1 "With English"
label values geng geng

graph bar h_group08 h_group11 if public==1, over(geng) ///
graphregion(fcolor(white)) legend(off) ///
bar(1, color(gray)) bar(2, fcolor(none) lcolor(black) lwidth(medium))
graph export "$doc\graph04a.png", replace

/* Distribution of hours English instruction */
