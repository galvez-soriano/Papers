...
save "mx_eng.dta", replace
*========================================================================*
use "mx_eng.dta", clear
drop if state==.
format eng* %12.2f

spmap eng2008 using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map01.png", replace

spmap eng2011 using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1) legend(off) 
graph export "$doc\map02.png", replace

spmap eng2008r using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1) legend(size(*2.5))
graph export "$doc\map01r.png", replace 

spmap eng2011r using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1) legend(off) 
graph export "$doc\map02r.png", replace

spmap eng2008u using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1) legend(off) 
graph export "$doc\map01u.png", replace

spmap eng2011u using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1) legend(off) 
