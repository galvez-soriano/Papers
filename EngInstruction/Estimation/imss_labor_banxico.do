...
*========================================================================*
/* Regressions Company Size by Abilities */
*========================================================================*
use "$base\dbase_18_21_final_alter.dta", clear
gen microf=f_size==0
gen smallf=f_size==1
...
/************* Low Enrollment Subsample *************/
eststo clear
eststo: areg microf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=., absorb(cct) vce(cluster cct)
eststo: areg smallf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=., absorb(cct) vce(cluster cct)
eststo: areg mediumf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=., absorb(cct) vce(cluster cct)
eststo: areg bigf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=., absorb(cct) vce(cluster cct)
esttab using "$doc\tab_com_size_low_abil.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Labor Market Outcomes) keep(h_eng q2_eng q3_eng q4_eng) stats(N ar2, fmt(%9.0fc %9.3f)) replace
/************* Low Enrollment Subsample (Men) *************/
eststo clear
eststo: areg microf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
...
eststo: areg bigf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=. & female==0, absorb(cct) vce(cluster cct)
esttab using "$doc\tab_com_size_low_men_abil.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Labor Market Outcomes) keep(h_eng q2_eng q3_eng q4_eng) stats(N ar2, fmt(%9.0fc %9.3f)) replace
/************* Low Enrollment Subsample (Women) *************/
eststo clear
eststo: areg microf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
...
eststo: areg bigf h_eng q2_eng q3_eng q4_eng quart* language6 math6 female n_stud age age2 t_colle ///
t_mast rural perma n_jobs i.state i.cohort i.year if ps38==1 & wage!=. & female==1, absorb(cct) vce(cluster cct)
esttab using "$doc\tab_com_size_low_women_abil.tex", cells(b(star fmt(%9.3f)) se(par)) ///
star(* 0.10 ** 0.05 *** 0.01) title(Labor Market Outcomes) keep(h_eng q2_eng q3_eng q4_eng) stats(N ar2, fmt(%9.0fc %9.3f)) replace
*========================================================================*
...
eststo: areg move_state eng_female t_eng language6 math6 female n_stud rural age age2 perma n_jobs ///
n_perma t_colle t_mast i.cohort i.year i.state if wage!=. & ps38==1, absorb(cct) vce(cluster cct)
esttab using "$doc\tab_labor_low.tex", ar2 cells(b(star fmt(%9.3f)) p(par([ ]))) ///
star(* 0.10 ** 0.05 *** 0.01) title(Labor Market Outcomes) keep(eng_female) replace
*========================================================================*
/* Robustness Checks */
*========================================================================*
