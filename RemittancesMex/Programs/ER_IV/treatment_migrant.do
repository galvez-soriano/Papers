...
*========================================================================*
use "$base\Remit1315.dta", clear
rename dremit remit 

merge 1:1 geo using "$base\MexPop.dta"
keep if _merge==3
gen dremit=(remit/year2020)*1000000

sum dremit, d
gen treat=dremit>=r(p75)
keep geo dremit treat
save "$base\Remit1315Treatment.dta", replace