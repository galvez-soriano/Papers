...
/*replace first_cohort = 2000 if first_cohort==0
gen K = cohort-first_cohort
gen D = K>=0 & first_cohort!=. 

keep first_cohort K D cohort geo state hrs_exp eng lwage paidw edu female 
order geo state cohort first_cohort K D
*/
