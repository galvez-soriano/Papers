...
save "$base\d_schools_new.dta", replace
*========================================================================*
...
*========================================================================*
use "$base\d_schools_new.dta", clear
...
forval i = 1/17 {
    ...
    replace hrs_exp = 0 if next_year_hrs_exp == 0 & !missing(next_year_hrs_exp) & year < year[_n+1] & year<=2000
...
/*
/* Aguascalientes */
bysort geo: replace hrs_exp=hrs_exp[_n-1]+gr_eng[_n] if hrs_exp[_n-1]>0 & gr_eng[_n]!=. & gr_eng[_n]<=0.25 & hrs_exp==. & state=="01"  & cohort>=1995
bysort geo: replace hrs_exp=hrs_exp[_n-1] if hrs_exp[_n-1]>hrs_exp[_n] & hrs_exp[_n]<hrs_exp[_n+1] & hrs_exp[_n+1]!=. & hrs_exp[_n-1]!=. & hrs_exp!=. & state=="01"  & cohort>=1995
/* Durango */
bysort geo: replace hrs_exp=hrs_exp[_n-1]+gr_eng[_n] if hrs_exp[_n-1]>0 & gr_eng[_n]!=. & gr_eng[_n]<=0.25 & hrs_exp==. & state=="10"  & cohort>=1996
bysort geo: replace hrs_exp=hrs_exp[_n-1] if hrs_exp[_n-1]>hrs_exp[_n] & hrs_exp[_n]<hrs_exp[_n+1] & hrs_exp[_n+1]!=. & hrs_exp[_n-1]!=. & hrs_exp!=. & state=="10"  & cohort>=1996
/* Nuevo Leon */
...
/* Sonora */
bysort geo: replace hrs_exp=hrs_exp[_n-1]+gr_eng[_n] if hrs_exp[_n-1]>0 & gr_eng[_n]!=. & gr_eng[_n]<=0.25 & hrs_exp==. & state=="26"  & cohort>=1987
bysort geo: replace hrs_exp=hrs_exp[_n-1] if hrs_exp[_n-1]>hrs_exp[_n] & hrs_exp[_n]<hrs_exp[_n+1] & hrs_exp[_n+1]!=. & hrs_exp[_n-1]!=. & hrs_exp!=. & state=="26"  & cohort>=1987
/* Tamaulipas */
bysort geo: replace hrs_exp=hrs_exp[_n-1]+gr_eng[_n] if hrs_exp[_n-1]>0 & gr_eng[_n]!=. & gr_eng[_n]<=0.25 & hrs_exp==. & state=="28"  & cohort>=1995
bysort geo: replace hrs_exp=hrs_exp[_n-1] if hrs_exp[_n-1]>hrs_exp[_n] & hrs_exp[_n]<hrs_exp[_n+1] & hrs_exp[_n+1]!=. & hrs_exp[_n-1]!=. & hrs_exp!=. & state=="28"  & cohort>=1995
/* Baja California Sur */
...
label var hrs_eng "Interpolated"
bysort state cohort: egen hrs_eng0=mean(hrs_exp0)
label var hrs_eng0 "With missings"

twoway (line hrs_eng year if state=="01") (line hrs_eng0 year if state=="01")
graph export "$base\figAGS.png", replace
twoway (line hrs_eng year if state=="10") (line hrs_eng0 year if state=="10")
graph export "$base\figDGO.png", replace
twoway (line hrs_eng year if state=="19") (line hrs_eng0 year if state=="19")
graph export "$base\figNL.png", replace
twoway (line hrs_eng year if state=="25") (line hrs_eng0 year if state=="25")
graph export "$base\figSIN.png", replace
twoway (line hrs_eng year if state=="26") (line hrs_eng0 year if state=="26")
graph export "$base\figSON.png", replace
twoway (line hrs_eng year if state=="28") (line hrs_eng0 year if state=="28")
...
rename hrs_exp hrs
reshape wide hrs, i(geo) j(year)

egen hrs_exp1996=rowmean(hrs2002 hrs2003 hrs2004 hrs2005 hrs2006 hrs2007)
egen hrs_exp1995=rowmean(hrs2001 hrs2002 hrs2003 hrs2004 hrs2005 hrs2006)
egen hrs_exp1994=rowmean(hrs2000 hrs2001 hrs2002 hrs2003 hrs2004 hrs2005)
egen hrs_exp1993=rowmean(hrs1999 hrs2000 hrs2001 hrs2002 hrs2003 hrs2004)
egen hrs_exp1992=rowmean(hrs1998 hrs1999 hrs2000 hrs2001 hrs2002 hrs2003)
egen hrs_exp1991=rowmean(hrs1997 hrs1998 hrs1999 hrs2000 hrs2001 hrs2002)
egen hrs_exp1990=rowmean(hrs1996 hrs1997 hrs1998 hrs1999 hrs2000 hrs2001)
egen hrs_exp1989=rowmean(hrs1995 hrs1996 hrs1997 hrs1998 hrs1999 hrs2000)
egen hrs_exp1988=rowmean(hrs1994 hrs1995 hrs1996 hrs1997 hrs1998 hrs1999)
egen hrs_exp1987=rowmean(hrs1993 hrs1994 hrs1995 hrs1996 hrs1997 hrs1998)
egen hrs_exp1986=rowmean(hrs1992 hrs1993 hrs1994 hrs1995 hrs1996 hrs1997)
egen hrs_exp1985=rowmean(hrs1991 hrs1992 hrs1993 hrs1994 hrs1995 hrs1996)
egen hrs_exp1984=rowmean(hrs1990 hrs1991 hrs1992 hrs1993 hrs1994 hrs1995)
egen hrs_exp1983=rowmean(hrs1990 hrs1991 hrs1992 hrs1993 hrs1994)
egen hrs_exp1982=rowmean(hrs1990 hrs1991 hrs1992 hrs1993)
egen hrs_exp1981=rowmean(hrs1990 hrs1991 hrs1992)
egen hrs_exp1980=rowmean(hrs1990 hrs1991)
egen hrs_exp1979=rowmean(hrs1990)

drop hrs20* hrs19*

reshape long hrs_exp, i(geo) j(cohort)
replace hrs_exp=0 if hrs_exp==.
