...
eststo clear
eststo: areg hrs_exp eng_female after_treat treat i.cohort i.edu female student work ///
indigenous [aw=weight], absorb(geo) vce(cluster geo)
eststo: areg eng eng_female after_treat treat i.cohort i.edu female student work ///
indigenous inc_hh edu_hh [aw=weight], absorb(geo) vce(cluster geo)
eststo: areg work eng_female after_treat treat i.cohort i.edu female indigenous ///
inc_hh edu_hh [aw=weight], absorb(geo) vce(cluster geo)
eststo: areg lwage eng_female after_treat treat i.cohort i.edu female student ///
indigenous [aw=weight], absorb(geo) vce(cluster geo)
/* Low education */
eststo: areg hrs_exp eng_female after_treat treat i.cohort i.edu female student work ///
indigenous [aw=weight] if edu<=9, absorb(geo) vce(cluster geo)
...
*========================================================================*
/* Staggered DiD: Nuevo Leon and Tamaulipas */
*========================================================================*
use "$base\eng_abil.dta", clear
