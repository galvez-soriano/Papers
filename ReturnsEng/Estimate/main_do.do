...
coefplot ///
age22 age23 age24 age25 age26 age27 age28 age_all, ///
...
/* XXX */
*========================================================================*
areg phy_act treat* i.cohort cohort i.edu female indigenous married ///
[aw=weight] if cohort>=1980 & cohort<=1995 & paidw==1, absorb(geo) vce(cluster geo)
coefplot, vertical keep(treat*) yline(0) omitted baselevels ///
xline(9, lstyle(grid) lpattern(dash) lcolor(ltblue)) ///
ytitle("Likelihood of working in physically-intensive occupations", size(medium) height(5)) ///
ylabel(-.5(0.25).5, labs(medium) grid format(%5.2f)) ///
xtitle("Cohorts since policy intervention", size(medium) height(5)) ///
xlabel(, angle(vertical) labs(medium)) ///
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
...
areg mov_obj treat* i.cohort cohort i.edu female indigenous married ///
[aw=weight] if cohort>=1980 & cohort<=1995 & paidw==1, absorb(geo) vce(cluster geo)
coefplot, vertical keep(treat*) yline(0) omitted baselevels ///
xline(9, lstyle(grid) lpattern(dash) lcolor(ltblue)) ///
ytitle("Likelihood of working in moving-objects jobs", size(medium) height(5)) ///
ylabel(-.5(0.25).5, labs(medium) grid format(%5.2f)) ///
xtitle("Cohorts since policy intervention", size(medium) height(5)) ///
xlabel(, angle(vertical) labs(medium)) ///
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
ysc(r(-0.5 .5)) recast(connected)
graph export "$doc\PTA_SDD_MovingOccup.png", replace
...
legend( pos(8) ring(0) col(1) region(lcolor(white)) size(medium)) ///
ysc(r(-.8 .8)) levels(90) 
graph export "$doc\PTA_SDD_MovingOccup_Educa.png", replace
...
legend( pos(8) ring(0) col(1) region(lcolor(white)) size(medium)) ///
ysc(r(-.8 .8)) levels(90) 
graph export "$doc\PTA_SDD_MovingOccup_Gender.png", replace

*========================================================================*

areg doc_info treat* i.cohort cohort i.edu female indigenous married ///
[aw=weight] if cohort>=1980 & cohort<=1995 & paidw==1, absorb(geo) vce(cluster geo)
coefplot, vertical keep(treat*) yline(0) omitted baselevels ///
xline(9, lstyle(grid) lpattern(dash) lcolor(ltblue)) ///
ytitle("Likelihood of working documenting-information", size(medium) height(5)) ///
ylabel(-.5(0.25).5, labs(medium) grid format(%5.2f)) ///
xtitle("Cohorts since policy intervention", size(medium) height(5)) ///
xlabel(, angle(vertical) labs(medium)) ///
graphregion(color(white)) scheme(s2mono) ciopts(recast(rcap)) ///
ysc(r(-0.5 .5)) recast(connected)
graph export "$doc\PTA_SDD_DocInfOccup.png", replace
...
legend( pos(8) ring(0) col(1) region(lcolor(white)) size(medium)) ///
ysc(r(-.8 .8)) levels(90) 
graph export "$doc\PTA_SDD_DocInfoOccup_Educa.png", replace
...
legend( pos(8) ring(0) col(1) region(lcolor(white)) size(medium)) ///
ysc(r(-.8 .8)) levels(90) 
graph export "$doc\PTA_SDD_DocInfoOccup_Gender.png", replace
