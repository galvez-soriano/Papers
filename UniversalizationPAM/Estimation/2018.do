...
gl data="C:\Users\Oscar Galvez Soriano\Documents\Papers\UniversalizationPAM\Data\2018\OData";
...
keep folioviv foliohog numren edad anac_e student niv_ed  time_tc
parentesco hli educ time_work time_study time_repair time_leisure time_lc;
...
use "$data\concentradohogar.dta", clear;
keep folioviv foliohog tam_loc factor_np tot_integ est_dis upm ubica_geo p65mas cereales carnes pescado leche huevo aceites tuberculo verduras frutas azucar cafe especias otros_alim bebidas tabaco edad_jefe sexo_jefe ali_dentro vesti_calz vestido calzado;
...
keep folioviv foliohog numren etnia discap asis_esc;
sort folioviv foliohog numren;
...
save "$bases\ingmon18.dta", replace;
...
sort folioviv foliohog;
save "$bases\monhogar18.dta", replace;


use "$bases\ingmon18.dta", clear;
...
sort folioviv foliohog;
save "$bases\monotro18.dta", replace;
...
merge folioviv foliohog using "$bases\monhogar18.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;

merge folioviv foliohog using "$bases\monotro18.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;
