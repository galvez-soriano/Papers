...
*Indicador de carencia por c
dad y espacios de la vivienda;
********************************************************************************
...
use "$data\concentradohogar.dta", clear;
keep folioviv foliohog tam_loc factor_np tot_integ p65mas cereales carnes pescado leche huevo aceites tuberculo verduras frutas azucar cafe especias otros_alim bebidas tabaco edad_jefe sexo_jefe ali_dentro vesti_calz vestido calzado est_dis upm ubica_geo;
...
save "$bases\ingmon16.dta", replace;
...
sort folioviv foliohog;
save "$bases\monhogar16.dta", replace;


use "$bases\ingmon16.dta", clear;
...
sort folioviv foliohog;
save "$bases\monotro16.dta", replace;
...
merge folioviv foliohog using "$bases\monhogar16.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;

merge folioviv foliohog using "$bases\monotro16.dta";
tab _merge;
drop _merge;
sort folioviv foliohog;
