...
event_plot ols_cropsP, ///
	...
	xlabel(-22(1)24, angle(90)) yline(0, lpattern(solid)) ///
...
graph export "$doc\PTA_TWFE_cropsP_ID.png", replace
...
event_plot ols_cropsQ, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_cropsQ_ID.png", replace
...
event_plot ols_energyP, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_energyP_ID.png", replace
...
event_plot ols_energyQ, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_energyQ_ID.png", replace
...
event_plot ols_hlaborp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_HLaborP_ID.png", replace
...
event_plot ols_hlaborq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_HLaborQ_ID.png", replace
...
event_plot ols_livestockp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_LivestockP_ID.png", replace
...
event_plot ols_livestockq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_LivestockQ_ID.png", replace
...
event_plot ols_oinputp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_OInputsP_ID.png", replace
...
event_plot ols_oinputq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_OInputsQ_ID.png", replace
...
event_plot ols_ulaborp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_ULaborP_ID.png", replace
...
event_plot ols_ulaborq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_ULaborQ_ID.png", replace
...
event_plot ols_agp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_AgP_ID.png", replace
...
event_plot ols_agq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_AgQ_ID.png", replace
...
event_plot ols_tfp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_TFP_ID.png", replace
...
event_plot ols_inputp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_InputsP_ID.png", replace
...
event_plot ols_inputq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_InputsQ_ID.png", replace
...
event_plot ols_iinputp, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_IInputsP_ID.png", replace
...
event_plot ols_iinputq, ///
    ...
    lag_opt1(msize(small) msymbol(O) mfcolor(navy) mlcolor(navy) mlwidth(thin)) lag_ci_opt1(color(navy) lwidth(medthick))
graph export "$doc\PTA_TWFE_IInputsQ_ID.png", replace
...
horizons(0/13) pretrend(13) ///
cluster(state) fe(state year) autos minn(0)
...
event_plot bjs_agp, ///
	...
	ylabel(-0.5(0.25)0.5, labs(medium) grid format(%5.2f)) ///
	ytitle("Percentage change in Ag Price", size(medium) height(5)) ///
	xlabel(-13(1)13, angle(90)) yline(0, lpattern(solid)) ///
	xline(-0.5, lstyle(grid) lpattern(dash) lcolor(red)) ///
	xtitle("Years since policy intervention", size(medium) height(5)) ///
	legend(off) ///
	) ///
